---
name: debug-mantra
description: ใช้เวลา debug bug จริงจัง บังคับให้เริ่มจาก reproduce ก่อน แล้วไล่ fail path, ตั้งสมมติฐาน, พิสูจน์หรือหักล้าง และจด breadcrumb ทุกครั้งที่ลอง ไม่ให้รีบเดาแล้วแก้มั่ว
---
