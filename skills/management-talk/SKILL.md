...
description: ใช้แปลงข้อความ technical ให้เป็นภาษาสำหรับ management, PM, VP, Slack, JIRA หรือ standup โดยยังเก็บสาระสำคัญ เช่น impact, owner, next step แต่ตัด code detail ที่ไม่จำเป็นออก
---
