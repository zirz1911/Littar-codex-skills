---
name: post-mortem
description: ใช้เขียน RCA หรือ postmortem หลัง bug ถูกแก้และ validate แล้ว สรุป symptom, root cause, fix, validation, ทำไมหลุดมาได้ และ follow-up สำหรับ engineer อ่าน
---
