---
name: scrutinize
description: ใช้ review แผน, PR, diff, หรือ design แบบคนข้างนอกมอง ถามก่อนว่าควรทำแบบนี้จริงไหม มีทางง่ายกว่านี้ไหม แล้วค่อย trace code path จริงเพื่อหา risk
---
